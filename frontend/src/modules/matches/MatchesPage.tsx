    ...
    <div className="animate-fade-in w-full max-w-[1400px] mx-auto min-w-0">
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-wrap items-stretch gap-4 animate-slide-up animate-stagger-1 relative z-40">
          ...
          {/* Zone 1: Position */}
          <div className="flex-1 min-w-[220px] bg-white/5 backdrop-blur-2xl border border-white/10 border-b-black/50 border-r-black/50 rounded-2xl p-2 px-4 shadow-[0_8px_30px_rgba(0,0,0,0.6)] flex flex-col justify-center transition-all hover:bg-white/10 relative z-10">
          ...
          {sources.length > 0 && (
            <div className="relative z-50">
              <div 
                className="w-[200px] h-full bg-white/5 backdrop-blur-2xl border border-white/10 border-b-black/50 border-r-black/50 rounded-2xl p-2 px-4 shadow-[0_8px_30px_rgba(0,0,0,0.6)] flex flex-col justify-center cursor-pointer transition-all hover:bg-white/10"
          ...
          {/* Zone 3: Top K */}
          <div className="w-[160px] bg-white/5 backdrop-blur-2xl border border-white/10 border-b-black/50 border-r-black/50 rounded-2xl p-2 px-4 shadow-[0_8px_30px_rgba(0,0,0,0.6)] flex flex-col justify-center transition-all hover:bg-white/10 relative z-10">
            <div className="flex items-center gap-1.5 mb-1 pointer-events-none">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-3.5 h-3.5 text-zinc-400">
