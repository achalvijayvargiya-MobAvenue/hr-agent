...
from hr_agent.core.database import SessionLocal, get_db  # re-exported so routers import from one place
from hr_agent.modules.integrations.candidate_sources.github import GitHubSource
from hr_agent.modules.integrations.candidate_sources.local_kb import LocalKBSource
from hr_agent.modules.integrations.candidate_sources.registry import SourceRegistry, source_registry
from hr_agent.modules.taxonomy.classification_service import DomainClassificationService
...
from hr_agent.core.services.pdf_service import extract_text as extract_pdf_text  # noqa: F401
...
def get_source_registry() -> SourceRegistry:
    ...
    from hr_agent.modules.integrations.candidate_sources.zoho_source import ZohoCandidateSource
    zoho = ZohoCandidateSource(db_session_factory=SessionLocal)
