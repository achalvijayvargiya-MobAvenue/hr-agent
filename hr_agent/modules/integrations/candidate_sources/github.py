...
from hr_agent.modules.integrations.candidate_sources.base import CandidateRecord, CandidateSource
from hr_agent.modules.integrations.candidate_sources.github_client import GitHubAPIError, GitHubClient
from hr_agent.modules.integrations.candidate_sources.github_query import GitHubQueryPlan, plan_github_search
